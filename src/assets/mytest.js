!function(e, t) {
    function i() {
      ...
      if (t.setAttribute("name", "viewport"), t.setAttribute("content", "initial-scale=" + s + ", maximum-scale=" + s + ", minimum-scale=" + s + ", user-scalable=no"), d.firstElementChild) {
        d.firstElementChild.appendChild(t)
      } else {
    ...
    function n() {
      var e = Math.min(d.getBoundingClientRect().width, window["adaptive"].maxWidth);
    ...
    i();
    var l, r = 100;
    t.desinWidth = window["adaptive"].desinWidth, t.baseFont = window["adaptive"].baseFont, t.init = function() {
